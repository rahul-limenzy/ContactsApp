...
$result = $contactsObj->contactsList();
$contactsObj->deleteContact();
?>
<!DOCTYPE html>
<html>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Contacts list</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <?php foreach ($result as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="viewContact.php?id=<?= $row['id']; ?>"><i class="fas fa-eye px-3"></i></a>
                                                <a href="editContact.php?id=<?= $row['id']; ?>"><i class="fas fa-edit px-3"></i></a>
                                                <a href="javascript:;" data-id="<?= $row['id'] ?>" class="delete" title="Delete">
                                                    <i id="delete" class="p-2 fa fa-trash"> </i>
