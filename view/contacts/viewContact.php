            ...
            <div class="col-md-8 mx-auto">
                <div class="card card-dark shadow">
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="row">
                            <div class="col-5">
                                <img src="../../dist/img/user1-128x128.jpg" alt="photo" class="img-circle img-fluid">
                            </div>
                            <div class="col-7 pt-md-5">
                                <h2><b><?php echo $result['details']['first_name'] . " " . $result['details']['last_name']; ?> </b></h2>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-7">
                                <?php foreach ($result['emails'] as $item) :?>
                                    <i class="fa fa-envelope pr-3 pb-3"></i>
                                    <?= $item['email'].'<br>'; ?>
                                <?php endforeach; ?>
                                <hr>
                                <?php foreach ($result['numbers'] as $item) :?>
                                    <i class="fa fa-phone  pr-3 pb-3"></i>
                                    <?= $item['number'].'<br>'; ?>
                                <?php endforeach; ?>
                            </div>
                            <div class="col-5" style="border-left: 1px solid rgba(0,0,0,.1);"> groups list here </div>
                        </div>
                        <?php else : ?>
